...
void
WorldPainter::paintWorldGround(QPainter &painter, const GameClient &client, const GameWorld &world, QWidget &widget,
...
void WorldPainter::paintWorldSky(QPainter &painter, const GameClient &client, const GameWorld &world, QWidget &widget,
                                 int width, int height,
                                 int viewPortStartPointX, int viewPortStartPointY, int worldStartPointX,
                                 int worldStartPointY, int displayBlockWidth) const
{
...
void
WorldPainter::paintWorldOverlay(QPainter &painter, const GameClient &client, const GameWorld &world, QWidget &widget,
                                int width,
                                int height)
{
...
void
WorldPainter::paintWorldPlayer(QPainter &painter, const GameClient &client, const GameWorld &world, QWidget &widget,
                               int width,
                               int height, int displayBlockWidth) const
{
    const auto &player = world.getPlayer();
    const QRect playerRect(width / 2 - displayBlockWidth / 2, height / 2 - displayBlockWidth * 6 / 5, displayBlockWidth,
                           displayBlockWidth * 3 / 2);
    ...
    if (player.isMoving())
    {
        ...
        switch (player.getFacing())
        {
            case Player::Facing::UP:
                resID = std::array<std::string, 3>{":/svl/textures/character/2_1_2.png",
                                                   ":/svl/textures/character/2_2_2.png",
                                                   ":/svl/textures/character/2_3_2.png"}[selection];
                break;
            case Player::Facing::DOWN:
                resID = std::array<std::string, 3>{":/svl/textures/character/2_1_0.png",
                                                   ":/svl/textures/character/2_2_0.png",
                                                   ":/svl/textures/character/2_3_0.png"}[selection];
                break;
            case Player::Facing::LEFT:
                resID = std::array<std::string, 3>{":/svl/textures/character/2_1_3.png",
                                                   ":/svl/textures/character/2_2_3.png",
                                                   ":/svl/textures/character/2_3_3.png"}[selection];
                break;
            case Player::Facing::RIGHT:
                resID = std::array<std::string, 3>{":/svl/textures/character/2_1_1.png",
                                                   ":/svl/textures/character/2_2_1.png",
                                                   ":/svl/textures/character/2_3_1.png"}[selection];
                break;
        }
...
void
WorldPainter::paintActionBeforePlayer(QPainter &painter, const GameClient &client, const GameWorld &world,
                                      QWidget &widget, int width,
...
void WorldPainter::paintActionAfterPlayer(QPainter &painter, const GameClient &client, const GameWorld &world,
                                          QWidget &widget, int width,
                                          int height, int displayBlockWidth)
{
    const auto &player = world.getPlayer();
...
void
WorldPainter::paintPickupActionBF(QPainter &painter, const GameClient &client, const GameWorld &world, QWidget &widget,
                                  int width,
                                  int height, int displayBlockWidth)
{
    const auto &player = world.getPlayer();
    ...
    if (player.getFacing() == Player::Facing::UP)
    {
        ...
        int((double) height / 2 - displayBlockWidth * 0.6 / 2 - displayBlockWidth * 0.5),
                ...
                int(displayBlockWidth * 0.6));
        painter.drawPixmap(playerRect,
                           QPixmap(dynamic_cast<const PickupAction *>(playerAction)->getItem().getTexture().c_str()));
    }
}

void WorldPainter::paintSmashActionBF(QPainter &painter, const GameClient &, const GameWorld &world, QWidget &widget,
                                      int width,
                                      int height, int displayBlockWidth)
{
    const auto &player = world.getPlayer();
...
void WorldPainter::paintPickupActionAF(QPainter &painter, const GameClient &, const GameWorld &world, QWidget &widget,
                                       int width,
                                       int height, int displayBlockWidth)
{
    const auto &player = world.getPlayer();
...
void WorldPainter::paintSmashActionAF(QPainter &painter, const GameClient &, const GameWorld &world, QWidget &widget,
                                      int width,
                                      int height, int displayBlockWidth)
{
    const auto &player = world.getPlayer();
